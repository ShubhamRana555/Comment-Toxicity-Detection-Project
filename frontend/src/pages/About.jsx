        ...
        >
          <MotionCard variants={cardVariants}>
            ...
            <CardContent sx={{ padding: 4,borderRadius: '10px' }}>
              ...
              <Typography variant="body1" color="text.secondary">
              Deploying on <b>Deploying on Vercel offers a streamlined and efficient process for hosting web applications and static sites. Vercel supports seamless integration with Git repositories, allowing developers to deploy projects directly from GitHub, GitLab, or Bitbucket with automatic deployments triggered on each commit. It leverages edge network capabilities for fast global delivery, ensuring low latency and high performance. Vercel provides built-in features like environment variable management, preview deployments for testing changes before going live, and automatic SSL certificate provisioning. Its intuitive dashboard and CLI tools simplify configuration and scaling, making Vercel an ideal choice for deploying modern web applications, static sites, and serverless functions.</b> offers a streamlined and efficient process for hosting web applications and static sites. Vercel supports seamless integration with Git repositories, allowing developers to deploy projects directly from GitHub, GitLab, or Bitbucket with automatic deployments triggered on each commit. It leverages edge network capabilities for fast global delivery, ensuring low latency and high performance. Vercel provides built-in features like environment variable management, preview deployments for testing changes before going live, and automatic SSL certificate provisioning. Its intuitive dashboard and CLI tools simplify configuration and scaling, making Vercel an ideal choice for deploying modern web applications, static sites, and serverless functions.
              </Typography>
              <div>
              </div>
            </CardContent>
